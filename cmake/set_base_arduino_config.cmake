...
target_include_directories(base_config INTERFACE
  ...
  "${BUILD_LIB_PATH}/Adafruit_TinyUSB_Arduino/src"
	"${BUILD_LIB_PATH}/Adafruit_TinyUSB_Arduino/src/arduino"
	"${BUILD_LIB_PATH}/Adafruit_TinyUSB_Arduino/src/arduino/ports/stm32"
  "${BUILD_LIB_PATH}/Adafruit_TinyUSB_Arduino/src/portable/st/stm32_fsdev"
